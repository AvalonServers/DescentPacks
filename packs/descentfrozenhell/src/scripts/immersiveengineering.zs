...
recipes.removeByRecipeName("immersivetech:stone_decoration/cokebrick_reinforced");
...
recipes.addShapeless(<immersiveengineering:stone_decoration:2>, [<ore:plateSoulforgedSteel>, <immersiveengineering:stone_decoration:1>, <immersiveengineering:stone_decoration:7>]);
...
recipes.addShapeless(<immersivetech:stone_decoration>, [<ore:plateSoulforgedSteel>, <immersiveengineering:stone_decoration>, <immersiveengineering:stone_decoration:7>]);
